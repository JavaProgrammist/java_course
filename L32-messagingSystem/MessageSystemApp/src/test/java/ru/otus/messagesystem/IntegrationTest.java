...
class IntegrationTest {
    ...
    void getDataById() throws Exception {
        ...
        LongStream.range(0, counter).forEach(id ->
                frontendService.getAllClients(id, data -> {
    ...
    void getDataAfterShutdown() throws Exception {
        ...
        frontendService.getAllClients(5, data -> logger.info("data:{}", data));
    ...
    private void createMessageSystem(boolean startProcessing) {
        ...
        requestHandlerDatabaseStore.addHandler(MessageType.GET_CLIENTS_DATA, new GetClientsDataRequestHandler(dbService));
        ...
        requestHandlerFrontendStore.addHandler(MessageType.GET_CLIENTS_DATA, new ClientOperationResultHandler());
