...
public class UsersWebServerWithBasicSecurity implements UsersWebServer {
    ...
    public UsersWebServerWithBasicSecurity(int port,
                                           ...
                                           Gson gson,
                                           TemplateProcessor templateProcessor, ClientConverter clientConverter) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientsServlet(templateProcessor, dbServiceClient,
                clientConverter)), "/clients");
        servletContextHandler.addServlet(new ServletHolder(new ClientsApiServlet(dbServiceClient, gson,
                clientConverter)), "/api/client/*");
